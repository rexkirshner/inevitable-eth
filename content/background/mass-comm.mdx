...
description: >-
  In 1994, Jim Clark and Marc Andreessen founded Mosaic Communications and
  released Netscape, introducing the general public to the internet.
category: background
tags:
  - background
  - history
...
But, we can take some important lessons from how to act during these times of uncertainty. One of the places that I look for answers is the dot com bubble, both its champions and its failures. 
