...
The leader then packages all these changes into a [block](/ethereum/blockchain/block); the rest of the network uses the block to sync their EVM with the proposer's.
...
[Deep Dive: PoS vs PoW](/ethereum/network/consensus/PoW-vs-PoS)
...
Within a block there are thousands [transactions](/ethereum/blockchain/block), but they execute atomically: either all together or none at all.
...
[Deep Dive: RANDAO](https://inevitableeth.com/home/ethereum/network/consensus/randao)
...
[Deep Dive: Proposal](/ethereum/network/consensus/block-proposal)
...
[Deep Dive: State Transition Function](https://inevitableeth.com/home/ethereum/network/consensus/state-transition)
...
[Deep Dive: Attestation](/ethereum/network/consensus/attestation)
...
[Deep Dive: LMD-GHOST](https://inevitableeth.com/home/ethereum/network/consensus/lmd-ghost)
...
[Deep Dive: Casper FFG](https://inevitableeth.com/home/ethereum/network/consensus/casper-ffg)
...
[Deep Dive: Sync Committee](/ethereum/network/consensus/sync-committee)
...
Source Material - [Twitter Link](https://twitter.com/SalomonCrypto/status/1579594609855934465)

Source Material - [PDF](/twitter-pdf-2022-10-10_pos.pdf)
