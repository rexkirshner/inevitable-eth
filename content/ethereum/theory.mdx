...
A [state machine](/ethereum/evm/state-machine) is a mathematical model of computation with two major components: 
...
But that's just for now. we already have mev-boost, a prototype of [Proposer-Builder Separation](/ethereum/upgrades/pbs) (PBS). 

The idea: block builders become a specialized entity, who provide prebuilt blocks to proposing nodes/validators.

PBS was born from MEV research, but the paradigm has become important for many of the upgrades to Ethereum (eg [Danksharding](/ethereum/upgrades/scaling/data)).
...
Source Material - [Twitter Link](https://twitter.com/SalomonCrypto/status/1587983584471633921)

Source Material - [PDF](/twitter-pdf-2022-11-03_state_size.pdf)
