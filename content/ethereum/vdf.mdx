...
All nodes must stay [perfectly in sync](https://inevitableeth.com/en/home/ethereum/network), processing the same [transactions](https://inevitableeth.com/home/ethereum/blockchain/transaction) and doing the same actions that every other node is doing.
...
Source Material - [Twitter Link](https://twitter.com/SalomonCrypto/status/1611774255360008192)
