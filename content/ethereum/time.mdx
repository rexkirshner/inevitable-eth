...
This randomness is non-trivial; we need [RANDAO](/ethereum/network/consensus/randao).
...
[Deep Dive: Ethereum State Transition Function](/ethereum/network/consensus/state-transition)

[Deep Dive: Casper FFG](/ethereum/network/consensus/casper-ffg)
...
Source Material - [PDF](/twitter-pdf-2022-10-06_time.pdf)
