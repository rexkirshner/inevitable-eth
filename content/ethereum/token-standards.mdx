...
description: >-
  Ethereum exists between a network of 1,000s of computers (nodes), each running
  a local version of the Ethereum Virtual Machine (EVM).
category: ethereum
parent: blockchain
tags:
  - ethereum
...
[Deep Dive: ERC-3475](/ethereum/erc-3475)
...
Then... Alan Turing → mechanical computing → [computers](/background/computer) → networked computers → ARPANET→ World Wide Web → Internet → Bitcoin 
...
Source Material - [Twitter Link](https://twitter.com/logarithmicrex/status/1553982842232717313)
