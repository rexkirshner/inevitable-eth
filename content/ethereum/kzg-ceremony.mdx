...
Ethereum is the [World Computer](https://inevitableeth.com/home/ethereum/world-computer), a network of 1,000s of computers ([nodes](https://inevitableeth.com/home/ethereum/network/node)) coordinating using [Proof of Stake](https://inevitableeth.com/home/ethereum/network/consensus/pos) (PoS) to keep the [Ethereum Virtual Machine](https://inevitableeth.com/home/ethereum/evm) (EVM) in sync.
...
[Deep Dive: Scaling Ethereum Execution](/ethereum/upgrades/scaling)
...
Yes, the EVM is [Turing-complete](/concepts/turing-complete) [virtual machine](/concepts/virtual-machine) and therefore capable of generalized [computation](/background/mass-comm/computer). We can think about turbo-charging the EVM until it can perform at the same level as a centralized platform (think [AWS](https://aws.amazon.com/)), but we already have high performance computing.
...
[Deep Dive: Rollups](/ethereum/upgrades/scaling)
...
If we don't scale the [data availability](/ethereum/upgrades/scaling/data/data-availability-bottleneck) of Ethereum mainnet, then execution scaling becomes a solution to the problem we don't have.

### Danksharding

[Deep Dive: Danksharding](/ethereum/upgrades/scaling/data)
...
[Deep Dive: Proto-Danksharding](https://inevitableeth.com/home/ethereum/upgrades/scaling/data/proto-danksharding)
...
KZG commitments are critical to the Danksharding scheme, as they are the mechanism by which the [network will sample the data](/ethereum/upgrades/scaling/data/p2p-network/data-availability-sampling). For more information, see the [Danksharding deep dive](/ethereum/upgrades/scaling/data).
