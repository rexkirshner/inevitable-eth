...
Any individual EVM is a window into the shared state of the [World Computer](https://inevitableeth.com/home/ethereum/world-computer). Each node keeps its EVM in sync through a [consensus mechanism](/ethereum/network/consensus) - Ethereum uses a specific implementation of [Proof of Stake](/ethereum/network/consensus/pos) (PoS).
...
In order for consensus, and therefore Ethereum, to operate, the system must [natively support property rights](/ethereum/evm/property-rights).
...
[Deep Dive: Programmable Money](/ethereum/world-computer/de-fi/programmable-money)
...
[Deep Dive: De-Fi is a Better Way](/ethereum/world-computer/de-fi/a-better-way)
...
[Deep Dive: The Internet Economy](/ethereum/world-computer/de-fi/internet-economy)
...
[I have some ideas](/ethereum/world-computer/endgame/trustless-trust), but who am I?
...
Source Material - [PDF](/twitter-pdf-2022-08-30_de-fi.pdf)
