...
Anyone can access the World Computer by submitting a [transaction](/ethereum/block) to the network.
...
[Deep Dive: MEV](/concepts/example)
...
An Ethereum node is a computer responsible for operating the World Computer and progressing the blockchain. ([Under Proof of Stake](/ethereum/pos)) the blockchain progresses when a block proposer (selected randomly) submits a new block to the network
...
[Deep Dive: Ethereum Block](/ethereum/block)
...
[Deep Dive: mev-boost](/ethereum/mev-boost)
...
As of today, the most important implication of protocol-enshrined PBS is that it enables [Danksharding](/ethereum/data). 

Danksharding is an upgrade that is still in the very early stages, but once deployed will increase the [data capacity](/ethereum/data-availability-bottleneck) ([especially for rollups](/ethereum/execution)) of Ethereum by orders of magnitude.
...
Source Material - [Twitter Link](https://twitter.com/logarithmicrex/status/1570557757190983680)
