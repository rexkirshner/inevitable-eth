...
description: >-
  Decentralization is a big word that refers to a lot of things, and there are a
  countless number of DAOs out there, all doing something unique.
category: ethereum
...
We can build [programmable money](/ethereum/programmable-money).

The best example is the [system developed by Curve Finance and Convex Finance](/ethereum/ve-tokens).  
...
Source Material - [Twitter Link](https://twitter.com/logarithmicrex/status/1548000445381062656)
