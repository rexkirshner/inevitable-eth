...
The EVM provides the context for [transactions](https://inevitableeth.com/home/ethereum/blockchain/transaction) (computation); everything you "do" on-chain happens within the EVM.
...
It starts with a [block](/ethereum/blockchain/block) - specifically a block header. Inside of the block header is the state root; using the state root, you can trustlessly verify Ethereum's state.
...
[Deep Dive: Sync Committtees](/ethereum/network/consensus/sync-committee)
...
Once every 256 [epochs](/ethereum/network/consensus/time) (~27 hours), 512 validators are randomly selected to be on the sync committee, who sign every single Ethereum block.
...
[Source Material - Twitter Link](https://twitter.com/SalomonCrypto/status/1613723126101348354)
