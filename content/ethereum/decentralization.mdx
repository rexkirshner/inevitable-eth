...
On first glance, this is achieved by [Proof of Stake](/ethereum/network/consensus/pos) (PoS).

PoS (and all [crypto-economic](/concepts/crypto-economics) [consensus mechanisms](/ethereum/network/consensus)) is a set of well defined systems and procedures that dictate how those operating Ethereum (specifically the [Ethereum Virtual Machine](/ethereum/evm) - EVM) coordinate.
...
In 2015, Ethereum extended that solution to apply to [general-purpose computing](/ethereum/evm/state-machine).
...
But for the most part, [I think that decentralization is a parlor trick DAOs use for 1) regulator cover and 2) community shaping/hype](/ethereum/world-computer/governance).

I recognize that I have a particularly cynical take, but let's just be realistic about "decentralized" DAOs.

I think of (non-Ethereum based discussions of) decentralization the same way [I think of validator-level censorship resistance](/ethereum/world-computer/regulation): a lot of unnuanced, often uneducated, debates about a problem that has been blown way of context.
...
Sreeram Kannan is the man behind [EigenLayer, the first (but not the last) re-staking collective](/ethereum/upgrades/middleware/eigenlayer/services).
...
In the Ethereum endgame, [ETH is the global currency of trustless trust](/ethereum/world-computer/endgame/trustless-trust).
...
Source Material - [Twitter Link](https://twitter.com/SalomonCrypto/status/1618083118195568640)
