...
Today, the [internal state](/ethereum/state-machine) of Ethereum requires ~500 GB to store locally.
...
[Deep Dive: Portal Network](/ethereum/light-clients)
...
Ethereum provides the way for the internet to [trustlessly express ownership](/ethereum/property-rights), light clients will allow trustless interaction.
...
[Deep Dive: Ethereum Middleware](/ethereum/middleware)

The path forward is already clear, the Middleware Gold Rush is inevitable.

Just like the [California Gold Rush of 1849 began when James Marshall found gold at Sutter's Mill](https://en.wikipedia.org/wiki/California_Gold_Rush), the Ethereum Middleware Gold Rush will begin when [Sreeram Kannan](https://twitter.com/sreeramkannan) launches [EigenLayer](/ethereum/eigenlayer) on mainnet.
...
[Deep Dive: Rollups](/ethereum/execution)
