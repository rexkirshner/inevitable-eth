...
Platforms like [Alchemy](https://www.alchemy.com/) allow users to interact with their nodes over an internet API.
...
Today, the [internal state](/ethereum/evm/state-machine) of Ethereum requires ~500 GB to store locally.
...
[Deep Dive: Portal Network](/ethereum/upgrades/light-clients)
...
Ethereum provides the way for the internet to [trustlessly express ownership](/ethereum/evm/property-rights), light clients will allow trustless interaction.
...
[You've heard of ETH as ultra sound money](https://ultrasound.money/)? 
...
[Deep Dive: Ethereum Middleware](/ethereum/upgrades/middleware)

The path forward is already clear, the Middleware Gold Rush is inevitable.

Just like the [California Gold Rush of 1849 began when James Marshall found gold at Sutter's Mill](https://en.wikipedia.org/wiki/California_Gold_Rush), the Ethereum Middleware Gold Rush will begin when [Sreeram Kannan](https://twitter.com/sreeramkannan) launches [EigenLayer](/ethereum/upgrades/middleware/eigenlayer) on mainnet.
...
[Deep Dive: Rollups](/ethereum/upgrades/scaling/execution)
...
Source Material - [Twitter Link](https://twitter.com/logarithmicrex/status/1590809909733441536)

Source Material - [PDF](/twitter-pdf-2022-11-10_trustless_trust.pdf)
