...
As of mid-September 2022, Ethereum has switched its [consensus mechanism](/ethereum/consensus) to [Proof of Stake](/ethereum/pos) (PoS).
...
Imagine the blockchain like a database that contains all the [transactions](/ethereum/transaction) that have ever happened on the World Computer. 

It is critical that this information is always directly available to any node; this is the [internal state](/ethereum/state-machine) of Ethereum.
...
The biggest obstacle we still need to overcome is the actual implementation of the [erasure coding](/concepts/erasure-code) and the [data availability sampling](/ethereum/data-availability-sampling) that is foundational to our P2P network design. 
...
[Deep Dive: Protocol-Enshrined PBS](/ethereum/pbs)
...
[Deep Dive: LMD-GHOST](/ethereum/lmd-ghost)  
...
Source Material - [Twitter Link](https://twitter.com/logarithmicrex/status/1585298274478542848)
