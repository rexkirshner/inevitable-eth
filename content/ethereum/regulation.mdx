...
Ethereum is a distributed computing platform. A network of 1,000s of computers ([nodes](/ethereum/network/node)) coordinating using [Proof of Stake](/ethereum/network/consensus/pos) (PoS) to keep the [Ethereum Virtual Machine](/ethereum/evm) (EVM) in sync.
...
[ETH will be the pristine currency of trustless trust](/ethereum/world-computer/endgame/trustless-trust).
...
Just like the laws of physics are built into our world, unbreakable [property rights are built into Ethereum](/ethereum/world-computer/internet-settlement).
...
*   Second, think about how transactions work; [specifically the market dynamics behind the priority fee/tip](/ethereum/network/consensus/eip-1559). Let's say Alice REALLY needs to push a transaction through ASAP. All she needs to do is increase the fee until a it creates a block more lucrative than one that's "censored."
