...
The core at the center of Ethereum is the EVM, specifically that the EVM has [native property rights](/ethereum/evm/property-rights).
...
This is the core idea behind Execution [transaction](/ethereum/blockchain/transaction) scaling: move execution off-chain, retain settlement on-chain.
...
[Deep Dive: Proto-Danksharding](/ethereum/upgrades/scaling/data/proto-danksharding)
...
To achieve full Danksharding, first we need to implement a [data sampling scheme that will distribute blobs across the network](/ethereum/upgrades/scaling/data/p2p-network). 
...
Source Material - [Twitter Link](https://twitter.com/SalomonCrypto/status/1591614638138875905)

Source Material - [PDF](/twitter-pdf-2022-11-12_scaling.pdf)
