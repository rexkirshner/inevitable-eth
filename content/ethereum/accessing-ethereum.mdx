...
[Deep Dive: Nodes](/ethereum/network/node)
...
But we have gotten started; [we've already built some of the more critical plumbing in to Ethereum PoS](/ethereum/network/consensus/sync-committee).
...
Source Material - [PDF](/twitter-pdf-2022-11-09_accessing_ethereum.pdf)
