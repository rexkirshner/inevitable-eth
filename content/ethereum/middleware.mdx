...
*   [updating the EVM](/ethereum/network/consensus/state-transition) ([once every 12 seconds](/ethereum/network/consensus/time)) 
*   [attesting](/ethereum/network/consensus/attestation) (once every 6.4 minutes) 
*   [proposing](/ethereum/network/consensus/block-proposal) (very rarely, ~.5 times per month) 
*   [sync committee](/ethereum/network/consensus/sync-committee) (even rarer, maybe once a year)
...
Source Material - [Twitter Link](https://twitter.com/SalomonCrypto/status/1589302062201700352)

Source Material - [PDF](/twitter-pdf-2022-11-06_middleware.pdf)
