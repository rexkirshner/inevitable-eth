...
[Deep Dive: Ethereum Transaction](/ethereum/transaction)
...
For Ethereum, versioning makes deploying large changes that affect the core of the protocol much easier (eg [account abstraction](/ethereum/account-abstraction)).
...
Source Material - [Twitter Link](https://twitter.com/logarithmicrex/status/1614432919430516739)
