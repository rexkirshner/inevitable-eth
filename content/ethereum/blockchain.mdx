...
[Deep Dive: Blocks](/ethereum/block)
...
\- distributed database technology, applying concepts like [sharding](/ethereum/data) and [history expiry](/ethereum/statelessness)
...
Long term, Ethereum mainnet will become the global settlement layer of global finance and the (rapidly) growing [internet economy](/ethereum/internet-economy).

[Property rights](/ethereum/property-rights) will derive from Ethereum while a host of new web3 technologies provide lightning fast execution with negligible [gas](/concepts/gas) fees.
