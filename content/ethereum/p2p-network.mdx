...
[The solution: rollups](/ethereum/upgrades/scaling/execution). Independent blockchains that use Ethereum as a [settlement](/concepts/settlement) layer.
...
[Deep Dive: Randomly Sampled Committees](/ethereum/upgrades/scaling/data/p2p-network/randomly-sampled-committees)
...
[Deep Dive: Data Availability Sampling](/ethereum/upgrades/scaling/data/p2p-network/data-availability-sampling)
...
Source Material - [Twitter Link](https://twitter.com/SalomonCrypto/status/1585042835459387392)

Source Material - [PDF](/twitter-pdf-2022-10-25_p2p_network.pdf)
