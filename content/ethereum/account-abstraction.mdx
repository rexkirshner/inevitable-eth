...
[Deep Dive: Ethereum Accounts](/ethereum/evm/account)
...
Within the context of the EVM, these "messages" are [transactions](/ethereum/blockchain/transaction). Thus, the digital signature shows the person with the private key authorized the transaction.
