...
Ethereum exists between a network of 1,000s of computers ([nodes](/ethereum/network/node)), each running a local version of the [Ethereum Virtual Machine](/ethereum/evm) (EVM). All copies of the EVM are kept perfectly in sync. 
...
A [block](/ethereum/blockchain/block) is a complete record of all the transactions that occurred within the EVM during each node's turn at being leader. 
...
Source Material - [Twitter Link](https://twitter.com/SalomonCrypto/status/1576016595452731394)

Source Material - [PDF](/twitter-pdf-2022-09-30_lmd-ghost.pdf)
