...
description: "BLS Digital Signatures A method of generating ; digital signatures appear as random data (there is no way to discover anything about the signer with just the signature."
category: "ethereum"
tags: []
difficulty: "advanced"
updated: "2023-01-12"
...
Ethereum uses a process called [RANDAO](https://inevitableeth.com/home/ethereum/randao) to generate "good-enough" randomness.
...
[Deep Dive: Proposal](https://inevitableeth.com/home/ethereum/block-proposal)

The first member of each committee is designated the block proposer. 

The proposer is responsible for building (or otherwise sourcing) a [block](/ethereum/block) and broadcasting it to the network. 

Each block progresses the state of the EVM and adds to the blockchain.

### Attestation

[Deep Dive: Attestation](https://inevitableeth.com/home/ethereum/attestation)
