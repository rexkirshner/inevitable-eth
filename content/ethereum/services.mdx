...
When it comes down to it, [proposing](/ethereum/network/consensus/block-proposal) or [attesting](/ethereum/network/consensus/attestation) to a [block](/ethereum/blockchain/block) is an action that an individual actor needs to take.
...
EigenLayer brings us a step closer to the endgame, when [ETH is the pristine collateral of trustless trust](/ethereum/world-computer/endgame/trustless-trust).
...
[Rollups](/ethereum/upgrades/scaling/execution), [bridges](/concepts/bridge) and [oracles](/concepts/oracle) are all services that require a centralized entity to take action on behalf of its users.
...
Source Material - [Twitter Link](https://twitter.com/SalomonCrypto/status/1617727903466422284)
