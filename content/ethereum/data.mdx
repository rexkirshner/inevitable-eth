---
title: "Scaling Data"
description: "is the \"final step in the transfer of ownership, involving the physical exchange of securities or payment\"."
category: "ethereum"
parent: "scaling"
tags: []
difficulty: "advanced"
...
As of mid-September 2022, Ethereum has switched its consensus mechanism from Proof of Work to [Proof of Stake](/ethereum/pos) (PoS).
...
[Deep Dive: Scaling Execution](https://inevitableeth.com/home/ethereum/execution)
...
[Deep Dive: EIP-4844 Proto-Danksharding](/ethereum/proto-danksharding)
...
Today, we post data to the blockchain by passing it into a smart contract through [the "calldata" field](/ethereum/transaction). This is a field that is intended for code and other data to be passed into the EVM. 

Therefore, Rollups post their receipts INTO the EVM. 

But... do they need to?

Let's consider a (hypothetical) [ZK-rollup](/ethereum/zk-rollup). 
...
[Deep Dive: Protocol-Enshrined Proposer-Builder Separation](/ethereum/pbs)
...
[Deep Dive: Danksharding P2P Network](/ethereum/p2p-network)
...
It's creating the KZG commitments and proofs for 64 blobs in a [single slot timeframe](/ethereum/time) (12 sec) that is particularly intense and will require a centralized actor. 
...
[Deep Dive: Danksharding Consensus Changes](/ethereum/consensus-changes)
