...
[If a smart contract adheres to a specific template, it is that kind of token](/ethereum/blockchain/token-standards).
...
Source Material - [PDF](/twitter-pdf-2022-09-04_erc-3475.pdf)
