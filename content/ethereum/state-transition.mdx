...
Ethereum is a distributed [state machine](/ethereum/evm/state-machine). A state machine is a mathematical model of computation with two major components: 
...
Source Material - [Twitter Link](https://twitter.com/SalomonCrypto/status/1577751304696274944)

Source Material - [PDF](/twitter-pdf-2022-10-05_state_transition.pdf)
