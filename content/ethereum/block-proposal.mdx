...
Ethereum uses a process called [RANDAO](/ethereum/network/consensus/randao) to generate "good-enough" randomness.
...
A [block](/ethereum/blockchain/block) is the atomic unit of time within the EVM. It is a bundle of transactions that happened during a slot.
...
Source Material - [PDF](/twitter-pdf-2022-10-26_block_proposal.pdf)
