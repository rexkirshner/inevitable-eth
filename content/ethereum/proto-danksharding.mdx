...
The first major upgrade has already happened: Ethereum will be switching its [consensus system](/ethereum/network/consensus) from Proof of Work to [Proof of Stake](/ethereum/network/consensus/pos).
...
The EVM is the virtual computing environment in which all of Etherum exists and all [transactions](/ethereum/blockchain/transaction) happen.
...
Today, rollups post into a field called "calldata," storage which persists on-chain forever. [You can see this data within a transaction](/ethereum/blockchain/transaction). 
...
Source Material - [Twitter Link](https://twitter.com/SalomonCrypto/status/1559402384526258176)

Source Material - [PDF](/twitter-pdf-2022-08-16_proto-danksharding.pdf)
