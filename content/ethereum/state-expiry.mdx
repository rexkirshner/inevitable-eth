...
Although a Merkle tree still is much more efficient that transferring the entire data set,  the [Merkle proofs are getting so large](/concepts/merkle-tree/scaling) we are running up against the same barriers. 

### State Size Management Theory

[Vitalik's Theory of Ethereum State Size Management:](/ethereum/upgrades/statelessness/theory)
...
Ethereum, [the World Computer](/ethereum/world-computer), exists between a network of 1,000s of computers ([nodes](https://inevitableeth.com/home/ethereum/network/node)), each running a local version of the [Ethereum Virtual Machine](https://inevitableeth.com/home/ethereum/evm) (EVM). 
...
Source Material - [PDF](/twitter-pdf-2022-11-03_state_expiry.pdf)
