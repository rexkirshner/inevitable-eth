...
[Deep Dive: ETH Time](/ethereum/time)
...
This distributed network of EVMs is held in sync via a [consensus mechanism](/ethereum/consensus). A consensus mechanism is a system by which a leader (block proposer) updates the state of their EVM and the rest of the network trustlessly follows.

Ethereum uses [Proof of Stake](/ethereum/pos) (PoS) as its consensus system.
...
Deep Dive: Voting Rules ([LMD-GHOST](/ethereum/lmd-ghost) and [Casper FFG](/ethereum/casper-ffg))
