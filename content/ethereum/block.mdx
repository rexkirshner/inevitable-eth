...
*   **transactions** - an ordered list of all the transactions executed within the block.
    *   [Deep Dive: Ethereum Transactions](/ethereum/blockchain/transaction)
...
*   Ethereum Blocks (PoS)
    *   Source Material - [Twitter Thread](https://twitter.com/SalomonCrypto/status/1568365818509139968)
    *   Source Material - [PDF](/twitter-pdf-2022-09-09_blocks_pos.pdf)
*   Ethereum Blocks (PoW)
    *   Source Material - [Twitter Thread](https://twitter.com/SalomonCrypto/status/1568233231748841474)
    *   Source Material - [PDF](/twitter-pdf-2022-09-09_blocks_pow.pdf)
