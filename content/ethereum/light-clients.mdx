...
Ethereum is the [World Computer](/ethereum/world-computer), a network of 1,000s of computers ([nodes](/ethereum/network/node)) coordinating using [Proof of Stake](/ethereum/network/consensus/pos) (PoS) to keep the [Ethereum Virtual Machine](/ethereum/evm) (EVM) in sync.
...
Users send requests & [transactions](/ethereum/blockchain/transaction) over an internet [API](/concepts/api); these platforms execute them on their behalf.
...
[Deep Dive: Stateless Ethereum](/ethereum/upgrades/statelessness)
...
[Statelessness](/ethereum/upgrades/statelessness/theory) is an important milestone on the way to light client support. 
...
Light clients + [middleware](/ethereum/upgrades/middleware) = the [World Computer](/ethereum/world-computer)

## Resources

Source Material - [Twitter Link](https://twitter.com/logarithmicrex/status/1590511339658571776)

Source Material - [PDF](/twitter-pdf-2022-11-09_light_clients.pdf)
