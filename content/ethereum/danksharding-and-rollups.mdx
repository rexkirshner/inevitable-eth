...
Each node runs a local version of the EVM, which is then held perfectly in sync with every other copy of the EVM through a process called [Proof of Stake](/ethereum/network/consensus) (PoS).
...
Enter Ethereum's [rollup](/ethereum/upgrades/scaling/execution)\-centric roadmap:
...
*   [Optimistic rollups](/ethereum/upgrades/scaling/execution/optimistic-rollup) automatically accept batches, but leave a challenge period for fraud proofs
*   [ZK-rollups](/ethereum/upgrades/scaling/execution/zk-rollup) submit validity proofs along with batches

## Data Availability Scaling

![](/images/randomly-sampled-committees-2.jpeg)

[Deep Dive: The Data Availability Bottleneck](/ethereum/upgrades/scaling/data/data-availability-bottleneck)
...
Post-Danksharding, when a blob is posted to Ethereum it will be immediately archived by services like [Etherscan](https://etherscan.io/) or the [Portal Network](/ethereum/upgrades/light-clients).
...
So let's talk specifically about how this would be implemented. Once again, if you don't have a good understanding of how rollups work, [please see this article](/ethereum/upgrades/scaling/execution).
...
If you found this interesting, then you might want to participate in building the core Ethereum protocol by [contributing](https://ceremony.ethereum.org/) to the [KZG-summoning ceremony](https://inevitableeth.com/en/home/ethereum/upgrades/scaling/data/proto-danksharding/kzg-ceremony)!

You've got ~2 months, but don't forget. Help secure the World Computer!

## Resources

Source Material - [Twitter Link](https://twitter.com/SalomonCrypto/status/1616647595501449216)
