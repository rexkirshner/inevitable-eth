...
A [Virtual Machine](/background/mass-comm/computer) (VM) is a computer program that emulates a complete, independent computer system entirely within another computing environment. Instead of developing software for a specific machine or type of machine, a VM allows development into a neutral environment. 
...
[Deep Dive: Ethereum State Machine](/ethereum/evm/state-machine)
...
Original Material - [PDF](/twitter-pdf-2022-09-27_evm.pdf)
