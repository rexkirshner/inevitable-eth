...
description: "To understand generational changes, you need to have a generational perspective. So, let's start from the beginning..."
category: "concepts"
tags: []
...
[Deep Dive: The History of Modern Finance 1492-2008](/background/history-finance)
...
The culmination: [Charles V](https://en.wikipedia.org/wiki/Charles_V,_Holy_Roman_Emperor), master of the (first) [empire on which the sun never sets](https://www.habsburger.net/en/chapter/charles-v-empire-which-sun-never-set). 

![](/images/background-charles-v.jpg)

[source](https://fineartamerica.com/featured/coronation-of-emperor-charles-v-in-bologna-gaspar-crayer.html)
...
The collusion of nobility and private capital gave the Europeans clear global dominance up until the 20th century. By then, the [systems had become so centralized](https://en.wikipedia.org/wiki/Concert_of_Europe) (and by implication, unstable) that they resulted in apocalypse: 

[World War I](https://en.wikipedia.org/wiki/World_War_I) & [World War II](https://en.wikipedia.org/wiki/World_War_II). 

![](/images/background-ww2-destruction.jpg)

[source](https://www.nytimes.com/2022/01/12/books/review/aftermath-harald-jahner.html)
...
The answer is simple, [Americans took](https://en.wikipedia.org/wiki/Destroyers-for-bases_deal) [what was important](https://en.wikipedia.org/wiki/Lend-Lease): uncontested control over the global financial system. 
...
(Side note: [this very fact was the justification Adolf Hitler gave for his aggression](https://www.amazon.com/Wages-Destruction-Making-Breaking-Economy/dp/0143113208). Something along the lines of “if someone doesn't challenge America TODAY, there is no hope for anything but total American hegemony”)
...
The USSR arose as an alternative to the Western system, but [it would not survive the century](https://en.wikipedia.org/wiki/Dissolution_of_the_Soviet_Union). 

![](/images/background-us-growth-chart.png)

[source](https://commons.wikimedia.org/wiki/File:Soviet_Union_USSR_GDP_per_capita.png)
...
[Deep Dive: The Global Financial Crisis](/background/gfc)
...
[source](https://www.cnbc.com/2018/09/10/investors-who-bought-into-the-teeth-of-the-lehman-crisis-are-up-130percent.html)

Beginning with the [nationalization of the mortgage insurance companies](https://www.reuters.com/article/us-fannie-freddie/government-takes-over-fannie-mae-freddie-mac-idUSN0527106320080907) and ending with the [nationalization of the general insurance market](https://money.cnn.com/2008/09/16/news/companies/AIG/), the US government bailed out the American (therefore global) financial system. 
...
[But the American people were left behind to deal with the blight](https://www.frbsf.org/economic-research/publications/economic-letter/2018/august/financial-crisis-at-10-years-will-we-ever-recover/). 
...
[Deep Dive: Western Sanctions](/background/sanctions)
...
[Deep Dive: Afghanistan](/background/afghanistan) 
...
[By 2022, America has been thrown into a state of civil unrest](https://en.wikipedia.org/wiki/January_6_United_States_Capitol_attack). 

[The UK left the EU, weakening the project](https://en.wikipedia.org/wiki/Brexit). 

[COVID-19](https://en.wikipedia.org/wiki/COVID-19_pandemic), [war in Ukraine](https://en.wikipedia.org/wiki/2022_Russian_invasion_of_Ukraine), [immigration crises](https://en.wikipedia.org/wiki/Mexico%E2%80%93United_States_border_crisis)... 

### China

![](/images/background-china.png)

[source](https://commons.wikimedia.org/wiki/File:Les_dirigeants_lors_du_20e_Congr%C3%A8s_du_Parti_communiste_chinois.png)

[All as an alternative rises: the Chinese system](https://en.wikipedia.org/wiki/Belt_and_Road_Initiative). Over the last 30 years they’ve grown from a humble country of rice farmers (with a long, storied history) to the first viable alternative to the Western Financial System since world domination even became possible. 

Some look at this moment and see a world order changing to reflect the realities of the 21st century. [Another turning of another chapter](https://www.youtube.com/watch?v=xguam0TKMw8), this time with China and the East atop the pile. 
...
In 2008, the Western Financial System failed… and [an alternative was born](https://bitcoin.org/bitcoin.pdf). 
...
*   [Key Players and Institutions](/background/entities)

## Resources

Source Material - [Twitter Link](https://twitter.com/logarithmicrex/status/1562996947371274241)
