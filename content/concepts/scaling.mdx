...
Ethereum uses Merkle trees to store the [state](/ethereum/evm/state-machine) of the [EVM](/ethereum/evm). Every account, balance, asset, protocol, etc is stored inside of Merkle tree, updated with every [block](/ethereum/blockchain/block), [every 12 seconds](/ethereum/network/consensus/time). 
...
Source Material - [Twitter Link](https://twitter.com/SalomonCrypto/status/1586391080727064577)

Source Material - [PDF](/twitter-pdf-2022-10-29_merkle_tree_scaling.pdf)
