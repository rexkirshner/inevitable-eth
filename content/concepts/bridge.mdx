...
For example, [EigenLayer](/ethereum/upgrades/middleware/eigenlayer) will transform ETH into the [pristine collateral of trustless-trust](/ethereum/world-computer/endgame/trustless-trust), allowing any service (including bridges) to operate trustlessly.
